...
// Relay pins
const int RELAY_PINS[] = {9, 10, 11, 13}; // 4 relays for 4 products
...
// Authorized sender phone number (replace with actual number)
const char* authorizedSender = "01521378632"; 
