...
void setup() {
  ...
  // Firebase configuration
  firebaseConfig.api_key = "AIzaSyAnspCpaOHQ9COq6ir4zpc79bolKcwVyRM";
...
void dispenseProduct() {
  ...
  if (!Firebase.set(firebaseData, path + "/timestamp", "time")) {
    Serial.println("Error logging timestamp");
  }
