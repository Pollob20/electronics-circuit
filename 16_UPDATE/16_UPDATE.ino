...
void dispenseProduct() {
  ...
  if (digitalRead(IR_SENSOR_PINS[relayIndex]) == LOW) {
    ...
    // Draw a checkmark
    display.drawLine(50, 40, 60, 50, SSD1306_WHITE);
    display.drawLine(60, 50, 80, 30, SSD1306_WHITE);
  } else {
    display.setCursor(0, 0);
    display.print("Dispensing Failed!");
    // Draw an X symbol
    display.drawLine(50, 40, 80, 70, SSD1306_WHITE);
    display.drawLine(80, 40, 50, 70, SSD1306_WHITE);
  }
  display.display();
