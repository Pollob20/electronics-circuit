...
#define FIREBASE_HOST "https://console.firebase.google.com/u/0/project/esp32-vanding-maching/database/esp32-vanding-maching-default-rtdb/data/~2F"
#define FIREBASE_AUTH "CxP7HFUo77dz6yNGANVBYjuS9ZgMYX3hhYV5PBVw"
...
void dispenseProduct() {
  ...
  Firebase.pushString(firebaseData, path + "/name", currentProduct.name);
  Firebase.pushFloat(firebaseData, path + "/price", currentProduct.price);
  Firebase.pushInt(firebaseData, path + "/stock", currentProduct.stock);
...
void logTransaction(const String& message) {
  String path = "/logs/";
  Firebase.pushString(firebaseData, path, message);
}
